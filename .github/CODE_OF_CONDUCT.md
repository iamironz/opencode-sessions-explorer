...
Report unacceptable behavior to the maintainers through the private channel
listed in [`SECURITY.md`](SECURITY.md) (GitHub Security Advisories). Do not open
public issues for conduct reports.

## Enforcement

Maintainers will review and investigate reports promptly and fairly. They will
take corrective action as needed and prioritize the safety of the community.
